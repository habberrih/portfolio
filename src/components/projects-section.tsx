...
import { Code, Wrench, Server, Cpu, X, ChevronLeft, ChevronRight, ExternalLink, Github } from "lucide-react"
...
const projects: Project[] = [
  {
    ...
    description: "A scalable API gateway built with NestJS for microservices architecture.",
    technologies: ["NestJS", "PostgreSQL", "Redis", "Docker"],
    image: "/api-gateway-architecture.jpg",
    images: ["/api-gateway-dashboard.jpg", "/microservices-diagram.jpg", "/api-documentation-concept.png"],
    fullDescription:
  ...
  },
  {
    ...
    description: "A scalable real-time chat platform built with Node.js and Socket.io.",
  ...
  },
  {
    ...
    description: "An automated tool for analyzing code quality and generating reports.",
    technologies: ["Node.js", "TypeScript", "ESLint", "SonarQube"],
    image: "/code-analysis-dashboard.png",
    images: ["/code-metrics-dashboard.jpg", "/quality-reports.jpg", "/code-visualization.png"],
    fullDescription:
  ...
  },
  {
    ...
    description: "IoT-based monitoring system for neonatal intensive care units.",
  ...
  },
  {
    ...
    description: "Automated tool for managing database schema migrations across environments.",
...
export function ProjectsSection() {
  ...
  const filteredProjects = filter === "all" ? projects : projects.filter((item) => item.category === filter)
        ...
        <div className="text-center mb-12">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-lg text-foreground/70">
              Explore my portfolio of projects spanning backend development, automation, IoT, and developer tools.
            </p>
          </div>
        </div>
                ...
                <div className="p-6">
                  <div className="flex flex-wrap gap-2 mb-3">
                    {project.technologies.slice(0, 3).map((tech) => (
                      <span key={tech} className="px-3 py-1 bg-[#F5F1E8] text-xs font-medium rounded-full">
                        {tech}
                      </span>
                    ))}
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-foreground leading-snug">{project.title}</h3>
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {selectedProject.technologies.map((tech) => (
                        <span key={tech} className="px-3 py-1.5 bg-[#F5F1E8] text-sm font-medium rounded-full">
                          {tech}
                        </span>
                      ))}
                    </div>
                    ...
                    <div className="mt-10 pt-8 border-t border-gray-200">
                      ...
                      <h4 className="text-xl font-semibold mt-6 mb-4">Impact & Results</h4>
                      <p className="leading-relaxed text-foreground/70">{selectedProject.impact}</p>
                    </div>
                  </div>
                </div>
              </motion.div>
