      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Based on my experience in backend development, IoT, and research, I
            offer the following specialized services that combine technical
            expertise with innovative solutions.
          </p>
        </div>
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="group bg-muted/50 rounded-xl p-10 text-center transition-all duration-300 hover:-translate-y-2.5 hover:shadow-xl shadow-md"
              >
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-primary/10 text-primary mb-5 transition-all duration-300 group-hover:bg-primary group-hover:text-primary-foreground">
        ...
        >
          <p className="text-lg md:text-xl mb-5 text-foreground">
            Need a custom service that's not listed here?
          </p>
          <a
            href="#contact"
