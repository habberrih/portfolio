...
import { Trophy, Heart, Plane, X, ChevronLeft, ChevronRight } from "lucide-react"
...
const newsItems: NewsItem[] = [
  ...
  },
  {
    ...
    description: "Won 1st prize for the best academic poster at Misurata University - Information Technology College.",
    date: "June 2023",
    image: "/academic-poster-presentation.jpg",
    images: ["/academic-poster-award-ceremony.jpg", "/academic-poster-display.jpg"],
    fullDescription:
    ...
    <section id="news" className="py-24 px-6 bg-[#F5F1E8] overflow-x-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">My News & Updates</h2>
          ...
          {[
            ...
            <button
              ...
              className={`relative px-5 py-2.5 text-base font-medium transition-colors ${
                filter === item.value ? "text-primary" : "text-foreground/60 hover:text-primary"
              }`}
            >
              {item.label}
              <span
          ...
          {filteredNews.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-6">
                  <span className="block text-sm text-foreground/60 mb-2">{item.date}</span>
                  <h3 className="text-xl font-bold mb-3 text-foreground leading-snug">{item.title}</h3>
              ...
              >
                ...
                <div className="overflow-y-auto flex-1 overflow-x-hidden">
                  ...
                  <div className="p-8">
                    ...
                    <h2 className="text-3xl font-bold mb-2.5 text-foreground">{selectedNews.title}</h2>
                    <span className="block text-base text-foreground/60 mb-5">{selectedNews.date}</span>
                    <p className="text-base leading-relaxed text-foreground/70 mb-8">{selectedNews.fullDescription}</p>

                    <div className="mt-10 pt-8 border-t border-gray-200">
                      <h3 className="text-2xl font-bold mb-4">Additional Details</h3>
                      <p className="mb-5 leading-relaxed text-foreground/70">
                        This section contains additional information about this event or achievement. The modal provides
                        a comprehensive view of the accomplishment with multiple images and detailed descriptions.
                      </p>

                      <h4 className="text-xl font-semibold mt-6 mb-4">Key Highlights</h4>
                      <ul className="ml-5 mb-5 space-y-2.5">
                        <li className="text-foreground/70">Important detail about this event</li>
                        <li className="text-foreground/70">Another significant aspect of this achievement</li>
                        <li className="text-foreground/70">People or organizations involved</li>
                        <li className="text-foreground/70">Skills demonstrated or acquired</li>
                      </ul>

                      <h4 className="text-xl font-semibold mt-6 mb-4">Impact</h4>
                      <p className="leading-relaxed text-foreground/70">
                        This section describes the impact of this event or achievement on career development, skills
                        enhancement, or personal growth. It provides context for why this item is featured in the
                        portfolio.
                      </p>
                    </div>
                  </div>
